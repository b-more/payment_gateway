  ...
  const openApi = new DocumentBuilder()
    ...
    .setDescription(
      [
        ...
        '',
        '## Authentication',
        '**Simple (recommended).** Send your key and secret on every call. There is no signing and no timestamp to manage.',
        '',
        '| Header | Value |',
        '| --- | --- |',
        ...
        '',
        '**Signed (optional).** Sign the request instead of sending the secret. This adds replay protection and body integrity. Send an `X-Signature` header and signed mode is used automatically.',
        '',
        '| Header | Value |',
        '| --- | --- |',
